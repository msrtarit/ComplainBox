...
namespace ComplainBox.Controllers
{
   ...
   // [Authorize(Roles = "Admin")]
    public class AdministrationController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> ListUsers(int? pageNo)
        {

            return View(await PaginatedList<IdentityUser>.ApplyPagingAsync(_userManager.Users.AsNoTracking().OrderBy(p => p.UserName), pageNo ?? 1, 10));
